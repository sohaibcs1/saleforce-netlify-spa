  ...
  methods: {
    async getData() {
      try {
        ...
        window.location.href = `https://login.salesforce.com/services/oauth2/authorize?client_id=3MVG9DREgiBqN9Wmlb9Hnby7AUEJb.iiEalt328_cNrVl6IHo8mzw1RpoyJWeypdCAZnm9zrb_7..azvf73l3&redirect_uri=http://localhost:8080/callback&response_type=code`;
